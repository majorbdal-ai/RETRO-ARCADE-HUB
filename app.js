...
const GAMES = [
  ...
  { id: 'sky-flap', name: 'Sky Flap', icon: '🐦', color: '#FFB800', desc: 'Tap to flap — dodge the pipes', featured: true, type: 'sky-flap', cat: 'Arcade', controls: 'tap' },
];
...
const CHALL_FALLBACK_POOL = ['2048', 'sky-flap'];
...
const GAME_SKIN = { _default: 'neon', '2048': 'neon', 'sky-flap': 'neon' };
